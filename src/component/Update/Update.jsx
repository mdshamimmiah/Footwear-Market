...
const data = useLoaderData();
    console.log(data);
   const {_id,price,description,name,rating,image} = data;
    ...
    const handleUpdateProduct = (event) => {
        ...
        const updateProduct = { name, description, price, brand, rating, image, discount, category }

        console.log(updateProduct);

        axiosPublic.put(`/update/${_id}`, updateProduct)
            .then(res => {
                        ...
                        <form onSubmit={handleUpdateProduct} className="card-body">
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                <div>
                                    ...
                                    <input className="w-[250px] lg:w-[500px] font-bold h-[40px] mt-3 p-3" type="text" name="name" defaultValue={name} placeholder="name" />
                                </div>
                                <div>
                                    <label className="mt-3 mb-3 ml-1  lg:ml-6  mr-2 text-white" >Price</label>
                                    <input className="w-[250px]  p-3 lg:w-[500px] font-bold lg: h-[40px] mt-3" type="text" name="price" defaultValue={price} placeholder="price" required />
                                </div>
                            </div>
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                <div>
                                    <span className="label-text mb-3 w-full  mr-2 text-white">Descr:</span>
                                    <input className="w-[250px] lg:w-[500px]  p-3 font-bold h-[40px] mt-3" type="text" name="description" defaultValue={description} placeholder="Description" />
                                </div>
                                <div>
                                    <div>
                                        <span className="label-text mb-3 w-full ml-0 lg:ml-5 mr-2 text-white">Rating</span>
                                        <input className="w-[250px] lg:w-[500px]  p-3 font-bold h-[40px] mt-3" type="text" name="rating" defaultValue={rating} placeholder="Rating" />
                                    </div>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                <div>
                                    ...
                                    <input className="w-[250px] lg:w-[500px]  p-3 font-bold h-[40px] mt-3" type="url" name="image"defaultValue={image} placeholder="Photo" />
                                </div>
                                <div>
                                    <div>
                                        <span className="label-text mb-3 w-full -ml-3 lg:ml-2 mr-9 text-white">Discount</span>
                                        <input className="w-[250px] lg:w-[500px]  p-3 font-bold h-[40px] -ml-8 mt-3" type="text" name="discount" placeholder="Discount" />
                                    </div>
                                </div>
                            </div>
